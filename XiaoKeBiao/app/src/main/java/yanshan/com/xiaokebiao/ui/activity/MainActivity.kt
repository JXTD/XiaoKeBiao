...
import yanshan.com.xiaokebiao.ui.fragment.CheckScoreFragment
import yanshan.com.xiaokebiao.ui.fragment.ClassScheduleFragment
import yanshan.com.xiaokebiao.ui.fragment.setting.SettingsFragment
import yanshan.com.xiaokebiao.util.DateUtils
import yanshan.com.xiaokebiao.util.FileUtils
import yanshan.com.xiaokebiao.util.Glide4Engine
...
class MainActivity : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
        ...
        if (App.sharedPreferences.getBoolean(ConstantPool.Str.ADD_GROUP_DIALOG_STATE.get(), true)) {
            AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("立即加入") { _, _ ->
                        val intent = Intent()
                        intent.data = Uri.parse("mqqopensdkapi://bizAgent/qm/qr?url=http%3A%2F%2Fqm.qq.com%2Fcgi-bin%2Fqm%2Fqr%3Ffrom%3Dapp%26p%3Dandroid%26k%3DD4EL0o-LwOzGq4rwkQwxI3qnXxGIbVln")
                        try {
    ...
    private fun startSelectImageActivity() {
        Matisse.from(this@MainActivity)
                ...
                .captureStrategy(CaptureStrategy(true, "yanshan.com.xiaokebiao.fileProvider"))
                //图片加载引擎
