...
import yanshan.com.xiaokebiao.entity.DataEntity
...
class ShareActivity : BaseActivity() {
    ...
    private fun shareFile() {
        ...
        val fileName = cacheDir.toString() + File.separator + "小氪表课程数据.json"
        try {
        ...
        val uri = FileProvider.getUriForFile(this, "yanshan.com.xiaokebiao.fileProvider", File(fileName))
    ...
    private fun exportFile() {
        ...
        intent.type = "*/*"
        val fileName = "小氪表课程数据" + SimpleDateFormat("yyyyMMddHHmmss", Locale.CHINESE).format(Date()) + ".json"
